...
public class Address {
	...
	public Address(int addrId, int userId, String addrProvince,
				   String addrCity, String addrArea, String addrContent,
	...
	public String toString() {
		return "Address [addrId=" + addrId + ", userId=" + userId
				+ ", addrProvince=" + addrProvince + ", addrCity=" + addrCity
				+ ", addrArea=" + addrArea + ", addrContent=" + addrContent
				+ ", addrReceiver=" + addrReceiver + ", addrTel=" + addrTel
